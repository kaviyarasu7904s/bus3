...
pudukkottai_btn.addEventListener("click", () => {
 ...
 pudukkottai_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
     create.classList = "create";
     create.innerHTML = "<h4>1). 10.43 Am to 11.30 Am</h3>" ;
     dinamic.appendChild(create);
 })
 pudukkottai_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
     create.classList = "create";
     create.innerHTML = "<h4>1). 9.10 Am to 11.00 Am</h3>" ;
     dinamic.appendChild(create);
 })
 pudukkottai_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
...
tiruppur_btn.addEventListener("click", () => {
 ...
 tiruppur_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
     create.classList = "create";
     create.innerHTML = "<h4>1). 07.00 Am to 8.12 Am</h3>" ;
     dinamic.appendChild(create);
 })
 tiruppur_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
     create.classList = "create";
     create.innerHTML = "<h4>1). 07.13 Am to 8.10 Am</h3>" ;
     dinamic.appendChild(create);
 })
 tiruppur_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
     create.classList = "create";
     create.innerHTML = "<h4>1). 08.00 Am to 9.10 Am</h3>" ;
     dinamic.appendChild(create);
 })
 tiruppur_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
     create.classList = "create";
     create.innerHTML = "<h4>1). 09.00 Am to 10.10 Am</h3>" ;
     dinamic.appendChild(create);
 })
...
oosur_btn.addEventListener("click", () => {
 ...
 oosur_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
     create.classList = "create";
     create.innerHTML = "<h4>1). 03.40 Am to 4.10 Am</h3>" ;
     dinamic.appendChild(create);
 })
 oosur_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
     create.classList = "create";
     create.innerHTML = "<h4>1). 05.00 Am to 6.50 Am</h3>" ;
     dinamic.appendChild(create);
 })
 oosur_btn.addEventListener("click", () => {
    const create = document.createElement("elemnt");
     create.classList = "create";
     create.innerHTML = "<h4>1). 07.00 Am to 8.10 Am</h3>" ;
     dinamic.appendChild(create);
 })